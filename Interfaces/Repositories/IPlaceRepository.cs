...
{
    Task<List<Place>> GetAllPlaces(RequestParameters requestParameters);
    Task<List<Place>> GetAllPlacesByLocation(int locationId, RequestParameters requestParameters);
